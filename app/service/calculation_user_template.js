angular.module('optinomicCalculation').factory('calculation', function() {
    ...
    calculation.main = function(responses) {
        ...
        calc.arrangeScoresInVars = function(current_vars, current_source) {
            ...
            current_vars.soziale_orientierung_sum_score.push(current_source.all_results.soziale_orientierung_sum_score);
            current_vars.soziale_orientierung_scale_score.push(current_source.all_results.soziale_orientierung_scale_score);
            current_vars.soziale_orientierung_z_score.push(current_source.all_results.soziale_orientierung_z_score);
            current_vars.offensivit__t_sum_score.push(current_source.all_results.offensivit__t_sum_score);
            current_vars.offensivit__t_scale_score.push(current_source.all_results.offensivit__t_scale_score);
            current_vars.offensivit__t_z_score.push(current_source.all_results.offensivit__t_z_score);
            current_vars.selbststeuerung_sum_score.push(current_source.all_results.selbststeuerung_sum_score);
            current_vars.selbststeuerung_scale_score.push(current_source.all_results.selbststeuerung_scale_score);
            current_vars.selbststeuerung_z_score.push(current_source.all_results.selbststeuerung_z_score);
            current_vars.reflexibilit__t_sum_score.push(current_source.all_results.reflexibilit__t_sum_score);
            current_vars.reflexibilit__t_scale_score.push(current_source.all_results.reflexibilit__t_scale_score);
            current_vars.reflexibilit__t_z_score.push(current_source.all_results.reflexibilit__t_z_score);
