angular.module('optinomicCalculation').factory('calculation', function() {
    ...
    calculation.main = function(responses) {
        ...
        calc.pdfmake_chart_zscore = function(scores, definition) {
            ...
            var d = _init(definition);


            console.warn('START: pdfmake_chart_zscore (scores, definition)', scores, definition, d);
        ...
        calc.getResults = function(myResponses) {
            ...
            responses_array.forEach(function(response, myindex) {
                ...
                // PDF
                d.pdfmake = {};
                d.pdfmake.chart_zscore = calc.pdfmake_chart_zscore(d, calc.chart);
